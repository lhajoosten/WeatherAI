...
class TestLocationGroupCrud:
    ...
    def test_location_group_endpoints_exist(self):
        ...
        expected_routes = [
            ...
            "/{group_id}/locations",  # POST /location-groups/{group_id}/locations
            "/{group_id}/locations/{location_id}",  # DELETE /location-groups/{group_id}/locations/{location_id}
            "/{group_id}",  # DELETE /location-groups/{group_id}
        ]
    ...
    async def test_location_group_creation_workflow(self):
        ...
        from app.api.v1.routes.location_groups import create_location_group
