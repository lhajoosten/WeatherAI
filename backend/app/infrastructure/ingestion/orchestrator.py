...
from app.infrastructure.ingestion.providers.openmeteo_forecast import OpenMeteoForecastProvider
from app.infrastructure.ingestion.providers.openmeteo_observation import OpenMeteoObservationProvider
