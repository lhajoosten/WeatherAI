...
def find_peak_rain_window(hourly_data: List[Dict], window_hours: int = 1) -> Optional[Window]:
...
def find_lowest_wind_window(hourly_data: List[Dict], window_hours: int = 2) -> Optional[Window]:
...
def generate_activity_blocks(hourly_data: List[Dict], user_preferences: Dict) -> List[ActivityBlock]:
    ...
    for period_name, start_hour, end_hour, description in periods:
