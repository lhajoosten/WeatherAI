...
class TestIngestionOrchestrator:
    ...
    async def test_error_message_truncation(self, orchestrator):
        ...
        # use a concrete exception type for the test to avoid broad Exception assertion
        orchestrator.air_quality_provider.fetch_air_quality = AsyncMock(side_effect=RuntimeError(long_error))
